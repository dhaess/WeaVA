    ...
    return (
        <div>
            ...
            <div className={"modalInfo"}>
                ...
                <p>Place information from <a href="https://map.geo.admin.ch/?topic=cadastre&lang=de&bgLayer=ch.swisstopo.pixelkarte-farbe&catalogNodes=15040" target="_blank" title="flaticon" rel="noreferrer">Federal Office of Topography</a></p>
                <p>Icons from <a href="https://www.flaticon.com/" target="_blank" title="swisstopo" rel="noreferrer">Freepik - Flaticon</a></p>
            </div>
        </div>
    )
}
